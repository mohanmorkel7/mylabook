      ...
      <DialogContent className="max-w-2xl">
        ...
        <div className="space-y-4">
          ...
          <div className="border-t pt-4">
            <h3 className="text-sm font-semibold mb-3">Email Matching Rules</h3>

            {/* From Email */}
            <div className="space-y-2 mb-3">
              <Label htmlFor="from_email">From Email Pattern</Label>
              <Input
                id="from_email"
                placeholder="e.g., sender@example.com or *@example.com"
            ...
            {/* To Email */}
            <div className="space-y-2 mb-3">
              <Label htmlFor="to_email">To Email Pattern</Label>
              <Input
                id="to_email"
                placeholder="e.g., tickets@mylapay.com"
            ...
            <div className="space-y-2 mb-3">
              ...
              <Input
                id="subject_pattern"
                placeholder="e.g., Invoice or Support Request"
                value={config.subject_pattern || ""}
                onChange={(e) =>
                  setConfig({ ...config, subject_pattern: e.target.value })
                }
              />
            </div>

            {/* Body Content with Match Type */}
            <div className="space-y-2 mb-3">
              <Label htmlFor="body_content">Body Content to Match</Label>
              <div className="flex gap-2">
                <Input
                  id="body_content"
                  placeholder="e.g., keyword or full text pattern"
                  value={config.body_content || ""}
                  onChange={(e) =>
                    setConfig({ ...config, body_content: e.target.value })
                  }
                  className="flex-1"
                />
                <Select
                  value={config.body_match_type || "word"}
                  onValueChange={(value) =>
                    setConfig({
                      ...config,
                      body_match_type: value as "word" | "full",
                    })
                  }
                >
                  ...
                  <SelectContent>
                    <SelectItem value="word">Contains Word</SelectItem>
          ...
          {/* Field Type and Value - Keep for backward compatibility */}
